...
/**
 * 튼튼한 주머니 그림. 주머니의 기본 그림 위에 그 줄의 색을 칠해 그린다. 허브 주머니는 아직
 * 파트별로 칠하는 방법을 확인하지 못해, 지도에 든 게임 기본 그림이 그대로 나온다(dye.ts 참고).
 *
 * 지도를 받기 전이나 지도에 없는 주머니는 파트 색을 나란히 칠한 칸으로 대신한다. 파트가
 * 그림의 어디에 해당하는지는 주머니 모양마다 달라서(실크는 상자, 꽃바구니는 바구니와 천)
 * 모양을 흉내 내지 않는다.
 *
